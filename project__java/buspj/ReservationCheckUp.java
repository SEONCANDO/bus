...
class CheckUp {
    ...
    public void insertData(String date, String start, String end, String starttime, String company, String db_class, String price, String seat) {
        this.date.add(date);
...
public class ReservationCheckUp extends JFrame implements MouseListener {
    ...
    public ReservationCheckUp(String id) {
        ...
        for (int i = 0; i < c.date.size(); i++) {
            String[] data = {c.date.get(i), c.start.get(i), c.end.get(i), c.starttime.get(i), c.company.get(i), c.db_class.get(i), c.price.get(i), c.seat.get(i)};
            model.addRow(data);
        }
