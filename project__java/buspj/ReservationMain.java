...
class Ticket {
    ...
    ArrayList<String> db_class = new ArrayList<String>();
    ArrayList<Integer> seats = new ArrayList<Integer>();
    ArrayList<Integer> price = new ArrayList<Integer>();

    public void insertTicket(String starttime, String company, String db_class, int seats, int price) {
        this.starttime.add(starttime);
        this.company.add(company);
        this.db_class.add(db_class);
...
//        }
        ...
        // 표 테이블에 티켓 정보 삽입
        for (int i = 0; i < len; i++) {
            String[] data = {t.starttime.get(i), t.company.get(i), t.db_class.get(i), String.valueOf(t.seats.get(i)), String.valueOf(t.price.get(i))};
            model.addRow(data);
        }
...
//        add(lookUp);
        ...
        checkup.setRolloverIcon(checkupUpdateIcon2); // 버튼에 마우스가 올라갈 때 이미지 변환
