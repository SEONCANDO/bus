...
public class DB_connect {
    ...
    public void sing_db(Member new_member) {
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql:" +
                            "//localhost:3306/bus", "root", "mysql");
            System.out.println("DB 연결 완료1");
            ...
            System.out.println("JDBC 드라이버 로드 에러1");
        } catch (SQLException e) {
            System.out.println("DB 연결 에러1");
        }
    }
    //id 중복체크 이벤트
    ...
    public String[] start() {
        ...
        try {
            ...
            System.out.println("JDBC 드라이버 로드 에러4");
        } catch (SQLException e) {
            System.out.println("DB 연결 에러4");
        }
        return null;
    }
    ...
    public String[] end() {
        ...
        try {
            ...
            System.out.println("JDBC 드라이버 로드 에러5");
        } catch (SQLException e) {
            System.out.println("DB 연결 에러5");
        }
        return null;
    }
...
//            pstmt.setString(0, end);
    ...
    public void minus_seats(String start, String end, String date, String[] info) {
        ...
        try {
            ...
            System.out.println("JDBC 드라이버 로드 에러8");
        } catch (SQLException e) {
            System.out.println("DB 연결 에러8");
        }
    }
...
//            pstmt.setString(7, date);
            ...
            System.out.println("JDBC 드라이버 로드 에러9");
        } catch (SQLException e) {
            System.out.println("DB 연결 에러9");
        }
    }
    ...
    public void saveUserReservation(String id, String start, String end, String date, int price, String[] info, int seatNum) {
        ...
        try {
            ...
            System.out.println("JDBC 드라이버 로드 에러10");
        } catch (SQLException e) {
            System.out.println("DB 연결 에러10");
        }
    }
    ...
    public String[] load_information(String id) {
        ...
        try {
            ...
            System.out.println("JDBC 드라이버 로드 에러12");
        } catch (SQLException e) {
            System.out.println("DB 연결 에러12");
        }
        return arr;
    }
    ...
    public void save_bus(String start, String end) {
        ...
        try {
            ...
            System.out.println("JDBC 드라이버 로드 에러13");
        } catch (SQLException e) {
            System.out.println("DB 연결 에러13");
        }
    }
    ...
    public int mileage(String id) {
        ...
        try {
            ...
            System.out.println("JDBC 드라이버 로드 에러14");
        } catch (SQLException e) {
            System.out.println("DB 연결 에러14");
        }
        return usermileage;
    }
    ...
    public void set_mileage(String id, int mileage) {
        ...
        try {
            ...
            System.out.println("JDBC 드라이버 로드 에러15");
        } catch (SQLException e) {
            System.out.println("DB 연결 에러15");
        }
    }
...
//    }
    ...
    public void seat_check(int number, int checknum, String id) {
        ...
        try {
            ...
            System.out.println("JDBC 드라이버 로드 에러17");
        } catch (SQLException e) {
            System.out.println("DB 연결 에러17");
        }
    }
    ...
    public void set_payment(int number, int payment) {
        ...
        try {
            ...
            System.out.println("JDBC 드라이버 로드 에러20");
        } catch (SQLException e) {
            System.out.println("DB 연결 에러20");
        }
    }
